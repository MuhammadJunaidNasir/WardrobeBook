...
export default class ProductScreen extends Component{
  ...
  <ScrollView>
      ...
      <View style={{width:250,flexDirection:'row',marginLeft:10,marginTop:10}}>
        <Button title="View Details" color="#1f0824" onPress={ ()=>{this.props.navigation.navigate('TShirt')} }   />
      </View>  
      ...
      <View style={{width:250,flexDirection:'row',marginLeft:10,marginTop:10}}>
        <Button title="View Details" color="#1f0824" onPress={ ()=>{this.props.navigation.navigate('Cap')} }   />
      </View>   
      ...
      <View style={{width:250,flexDirection:'row',marginLeft:10,marginTop:10}}>
        <Button title="View Details" color="#1f0824" onPress={ ()=>{this.props.navigation.navigate('Coat')} }   />
      </View> 
      ...
      <View style={{width:250,flexDirection:'row',marginLeft:10,marginTop:10}}>
        <Button title="View Details" color="#1f0824" onPress={ ()=>{this.props.navigation.navigate('jeans')} }   />
      </View> 
      ...
      <View style={{width:250,flexDirection:'row',marginLeft:10,marginTop:10}}>
        <Button title="View Details" color="#1f0824" onPress={ ()=>{this.props.navigation.navigate('dresspent')} }   />
      </View>
      ...
      <View style={{width:250,flexDirection:'row',marginLeft:10,marginTop:10}}>
        <Button title="View Details" color="#1f0824" onPress={ ()=>{this.props.navigation.navigate('sportshirt')} }   />
      </View>
      ...
      <View style={{width:250,flexDirection:'row',marginLeft:10,marginTop:10}}>
        <Button title="View Details" color="#1f0824" onPress={ ()=>{this.props.navigation.navigate('sporttrouser')} }   />
      </View>
